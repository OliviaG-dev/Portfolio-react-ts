          ...
          <span className="header_brand_text">
            ...
            <span className="header_brand_tagline">
              ...
              <span className="header_brand_shine">
                ...
                >
                  <path
                    d="M8 0.6L9.35 6.65L15.4 8L9.35 9.35L8 15.4L6.65 9.35L0.6 8L6.65 6.65Z"
                    fill="currentColor"
                  />
                </svg>
                <svg
                ...
                >
                  <path
                    d="M8 1.2L8.95 6.2L13.9 5.05L10.2 8L13.9 10.95L8.95 9.8L8 14.8L7.05 9.8L2.1 10.95L5.8 8L2.1 5.05L7.05 6.2Z"
                    fill="currentColor"
                  />
                </svg>
                <svg
                ...
                >
                  <path
                    d="M8 1.4c.2 2.4 1.2 4.2 3.6 5.2-2.4 1-3.4 2.8-3.6 5.2-.2-2.4-1.2-4.2-3.6-5.2C6.8 5.6 7.8 3.8 8 1.4Z"
                    fill="currentColor"
                  />
                </svg>
              </span>
